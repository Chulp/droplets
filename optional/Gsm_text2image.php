...
//:Use [[Gsm_text2image?text=The text to create]]  
//Text2Image adapted with colour
//clean up old files..
$dir = WB_PATH.'/temp/';
...
$text_color = imagecolorallocate($image_handle, 70, 70, 70);
$background_color = imagecolorallocate($image_handle, 242, 242, 242);
